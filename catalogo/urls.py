...
#from . import views
from .views import home, login_view, cadastro, ver_filmes, adicionar_filme, editar_filme, remover_filme, ver_filme, buscar_filmes
...
urlpatterns = [
    ...
    path('buscar_filmes/', buscar_filmes, name='buscar_filmes'),
]
